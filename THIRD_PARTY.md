# Third-party licenses — crypto-database

**The Change License does not relicense dependencies.** When crypto-database 4.0.0
becomes Apache-2.0 on 2030-09-11, that applies to its own source. Every
dependency keeps its own terms, permanently.

crypto-database is a distribution of NEDB and carries the same dependency graph, but
